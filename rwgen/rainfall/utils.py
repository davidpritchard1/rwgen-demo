...
def _apply_demo_parameter_bounds(parameters_to_fit):
    ...
    upper = {}
    lower['lamda'] = [
        0.014077, 0.011081, 0.011636, 0.010178, 0.008659, 0.01247, 0.008366, 0.014882, 0.008856, 0.010876,
        0.018, 0.012807
    ]
    upper['lamda'] = [
        0.017206, 0.013544, 0.014222, 0.01244, 0.010584, 0.015242, 0.010225, 0.01819, 0.010824, 0.013292,
        0.022, 0.015653
    ]
    lower['beta'] = [
        0.04582, 0.042615, 0.044593, 0.044415, 0.065449, 0.109416, 0.029669, 0.095663, 0.059852, 0.025691,
        0.056257, 0.03922
    ]
    upper['beta'] = [
        0.056002, 0.052085, 0.054502, 0.054286, 0.079994, 0.13373, 0.036262, 0.116922, 0.073152, 0.0314,
        0.068758, 0.047935
    ]
    lower['nu'] = [
        6.36151, 6.61921, 5.08069, 5.179594, 14.418961, 6.932925, 3.994916, 4.159222, 10.261724, 4.807733, 4.520538,
        6.036307
    ]
    upper['nu'] = [
        7.775179, 8.090146, 6.209732, 6.330614, 17.623174, 8.473575, 4.882676, 5.083494, 12.542107, 5.876118,
        5.525102, 7.377708
    ]
    lower['eta'] = [
        1.201574, 1.069869, 0.769049, 0.738915, 1.764068, 1.804413, 0.668935, 1.319149, 1.658972, 0.601678,
        0.900527, 0.92027
    ]
    upper['eta'] = [
        1.468591, 1.307617, 0.939948, 0.903118, 2.156083, 2.205394, 0.817588, 1.612293, 2.027633, 0.735385,
        1.100645, 1.124774
    ]
    lower['theta'] = [
        0.888978, 0.789024, 0.635059, 0.710231, 0.459037, 0.82173, 0.528132, 1.108056, 0.774727, 0.773159, 0.798634,
        0.898818
    ]
    upper['theta'] = [
        1.086529, 0.964363, 0.776183, 0.86806, 0.561046, 1.004337, 0.645494, 1.354291, 0.946889, 0.944972, 0.976108,
        1.098555
    ]
    lower['kappa'] = [
        0.812077, 0.852862, 0.747277, 0.823183, 0.45, 0.572212, 0.45, 0.683437, 0.549874, 0.725159, 0.761345,
        0.859947
    ]
    upper['kappa'] = [
        0.992539, 1.042387, 0.913339, 1.006112, 0.55, 0.69937, 0.55, 0.835312, 0.672068, 0.886306, 0.930533,
        1.051046
    ]
    parameter_bounds = {}  # key = season, values = list of tuples (lower bound, upper bound)
