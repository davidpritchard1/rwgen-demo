...
def _apply_demo_parameter_bounds(parameters_to_fit):
    # Single site (Brize Norton)
    lower = {}
    upper = {}
    lower['lamda'] = [
        0.014859, 0.011697, 0.012282, 0.010743, 0.00914, 0.013163, 0.00883, 0.015709, 0.009348, 0.01148, 0.019, 0.013519
    ]
    upper['lamda'] = [
        0.016424, 0.012928, 0.013575, 0.011874, 0.010103, 0.014549, 0.00976, 0.017363, 0.010332, 0.012688, 0.021,
        0.014942
    ]
    lower['beta'] = [
        0.048365, 0.044982, 0.04707, 0.046883, 0.069086, 0.115494, 0.031317, 0.100978, 0.063177, 0.027119, 0.059382,
        0.041398
    ]
    upper['beta'] = [
        0.053456, 0.049717, 0.052025, 0.051818, 0.076358, 0.127652, 0.034614, 0.111607, 0.069827, 0.029973, 0.065633,
        0.045756
    ]
    lower['nu'] = [
        6.714927, 6.986944, 5.362951, 5.467349, 15.220014, 7.318088, 4.216856, 4.39029, 10.831819, 5.074829, 4.771679,
        6.371657
    ]
    upper['nu'] = [
        7.421762, 7.722412, 5.927472, 6.042859, 16.822121, 8.088413, 4.660736, 4.852426, 11.972011, 5.609022, 5.273961,
        7.042358
    ]
    lower['eta'] = [
        1.268329, 1.129306, 0.811774, 0.779965, 1.862071, 1.904658, 0.706099, 1.392435, 1.751137, 0.635105, 0.950557,
        0.971396
    ]
    upper['eta'] = [
        1.401837, 1.24818, 0.897223, 0.862067, 2.058079, 2.105149, 0.780425, 1.539007, 1.935468, 0.701958, 1.050615,
        1.073648
    ]
    lower['theta'] = [
        0.938366, 0.832859, 0.67034, 0.749688, 0.48454, 0.867382, 0.557472, 1.169615, 0.817768, 0.816113, 0.843002,
        0.948752
    ]
    upper['theta'] = [
        1.037141, 0.920528, 0.740902, 0.828603, 0.535544, 0.958685, 0.616154, 1.292732, 0.903848, 0.902019, 0.931739,
        1.048621
    ]
    lower['kappa'] = [
        0.857192, 0.900243, 0.788793, 0.868915, 0.475, 0.604001, 0.475, 0.721406, 0.580423, 0.765446, 0.803642, 0.907721
    ]
    upper['kappa'] = [
        0.947423, 0.995005, 0.871824, 0.96038, 0.525, 0.66758, 0.525, 0.797343, 0.64152, 0.846019, 0.888236, 1.003271
    ]
    parameter_bounds = {}  # key = season, values = list of tuples (lower bound, upper bound)
    for m in range(1, 12 + 1):
        parameter_bounds[m] = []
        for parameter in parameters_to_fit:
            parameter_bounds[m].append((lower[parameter][m - 1], upper[parameter][m - 1]))
